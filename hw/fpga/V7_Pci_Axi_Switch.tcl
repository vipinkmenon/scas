# 
# Project automation script for V7_Pci_Axi_Switch 
# 
...
set myProject "V7_Pci_Axi_Switch"
set myScript "V7_Pci_Axi_Switch.tcl"
...
proc add_source_files {} {
   ...
   xfile add "source/enet_if/v7_emac_controller.v"
   xfile add "source/enet_if/v7_enet_top.v"
   xfile add "source/enet_if/v7_ethernet_controller.v"
   xfile add "source/enet_if/v7_ethernet_controller_top.v"
   xfile add "source/enet_if/v7_ethernet_top.v"
   xfile add "source/memory_if/four_port_ddr_ctrl.v"
   xfile add "source/memory_if/v7_ddr.v"
   xfile add "source/memory_if/v7_ddr_top.v"
   xfile add "source/multiboot_ctrl/multiboot_ctrl.v"
   xfile add "source/pcie_if/mem_ctrl.v"
   xfile add "source/pcie_if/pcie_7x_v1_8.v"
   xfile add "source/pcie_if/pcie_7x_v1_8_pipe_clock.v"
   ...
   xfile add "source/pcie_if/v7_pcie_top.v"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "D:/SHS/Research/fpgaflow/git_folder/fpgaflow/FPT2013/HW/FPGA/ISE/xst" -process "Synthesize - XST"
