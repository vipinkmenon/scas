# 
# Project automation script for V6_Pci_Axi_Switch 
# 
# Created for ISE version 14.3
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source V6_Pci_Axi_Switch.tcl), then you can
...
set myProject "V6_Pci_Axi_Switch"
set myScript "V6_Pci_Axi_Switch.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ipcore_dir/data_fifo.ngc"
   xfile add "ipcore_dir/data_fifo.v"
   xfile add "ipcore_dir/ddr_rd_fifo.xco"
   xfile add "ipcore_dir/ddr_stream_fifo.v"
   xfile add "ipcore_dir/dp_ram_blank.v"
   xfile add "ipcore_dir/rx_fifo_blank.v"
   xfile add "ipcore_dir/sys_mon.xco"
   xfile add "ipcore_dir/track_fifo.v"
   xfile add "ipcore_dir/tx_fifo_blank.v"
   xfile add "ipcore_dir/user_fifo.xco"
   xfile add "ipcore_dir/user_strm_fifo.xco"
   xfile add "source/clock_gen/mmcm_drp.v"
   xfile add "source/clock_gen/user_clock_gen.v"
   xfile add "source/enet_if/enet_ddr_ctrl.v"
   xfile add "source/enet_if/eth_rcr_unpack.v"
   xfile add "source/enet_if/eth_tcr_pack.v"
   xfile add "source/enet_if/ethernet_controller.v"
   xfile add "source/enet_if/ethernet_controller_top.v"
   xfile add "source/enet_if/ethernet_top.v"
   xfile add "source/enet_if/reset_sync.v"
   xfile add "source/enet_if/v6_emac_v2_2_fifo_block.v"
   xfile add "source/memory_if/four_port_ddr_ctrl.v"
   xfile add "source/memory_if/v6_ddr_top.v"
   xfile add "source/multiboot_ctrl/multiboot_ctrl.v"
   xfile add "source/pcie_if/mem_ctrl.v"
   xfile add "source/pcie_if/pcie_app.v"
   xfile add "source/pcie_if/pcie_ddr_dma_controller.v"
   xfile add "source/pcie_if/reg_file.v"
   xfile add "source/pcie_if/rx_engine.v"
   xfile add "source/pcie_if/tx_engine.v"
   xfile add "source/pcie_if/v6_pcie_top.v"
   xfile add "source/pcie_if/v6_pcie_v2_5.v"
   xfile add "source/switch_top.v"
   xfile add "source/top.v"
   xfile add "source/user_logic_if/user_ddr_stream_generator.v"
   xfile add "source/user_logic_if/user_ddr_strm_arbitrator.v"
   xfile add "source/user_logic_if/user_dma_req_arbitrator.v"
   xfile add "source/user_logic_if/user_logic_top.v"
   xfile add "source/user_logic_if/user_pcie_stream_generator.v"
   xfile add "source/userlogic/user_logic.v"
   xfile add "source/v6_top.ucf"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Last Applied Strategy" "SmartXplorer - maplogoptregdup"
   ...
   project set "Target UCF File Name" "source/v6_top.ucf" -process "Back-annotate Pin Locations"
